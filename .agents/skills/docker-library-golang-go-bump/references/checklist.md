...
4. Generate commit list excluding last from previous branch:
   - `.codex/skills/docker-library-golang-go-bump/scripts/cherry-picks-except-last.sh <source-branch>`
...
- Cherry-picked commit list does not include previous branch HEAD.
